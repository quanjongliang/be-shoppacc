...
exports.createCharacterTag1652837732421 = void 0;
const entity_1 = require("../src/entity");
class createCharacterTag1652837732421 {
    async up(queryRunner) {
        ...
        const saveCharlist = characterList.map((char) => {
            const { id, name, slug } = char, inf = __rest(char, ["id", "name", "slug"]);
...
exports.createCharacterTag1652837732421 = createCharacterTag1652837732421;
//# sourceMappingURL=1652837732421-createCharacterTag.js.map