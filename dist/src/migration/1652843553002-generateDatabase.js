...
exports.generateDatabase1652843553002 = void 0;
class generateDatabase1652843553002 {
    constructor() {
        this.name = 'generateDatabase1652843553002';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "tag_accounts_account" ("tagId" uuid NOT NULL, "accountId" uuid NOT NULL, CONSTRAINT "PK_759fde8bae4c19723b6dc72c85e" PRIMARY KEY ("tagId", "accountId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4121f1577f3dc85cebd9b109aa" ON "tag_accounts_account" ("tagId") `);
        await queryRunner.query(`CREATE INDEX "IDX_ae9f2234d7f72bf22437186fda" ON "tag_accounts_account" ("accountId") `);
        ...
        await queryRunner.query(`ALTER TABLE "cloundinary" ADD CONSTRAINT "FK_d465d84c96697a409b7117ccd98" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "auditInformation" ADD CONSTRAINT "FK_76f53a1b0bc32bd119d03134bb6" FOREIGN KEY ("auditId") REFERENCES "audit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "post" ADD CONSTRAINT "FK_6cd0258bc7d0d3bf4707895b13b" FOREIGN KEY ("cloundinaryPublicId") REFERENCES "cloundinary"("public_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "tag_accounts_account" ADD CONSTRAINT "FK_4121f1577f3dc85cebd9b109aa7" FOREIGN KEY ("tagId") REFERENCES "tag"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "tag_accounts_account" ADD CONSTRAINT "FK_ae9f2234d7f72bf22437186fda1" FOREIGN KEY ("accountId") REFERENCES "account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "tag_accounts_account" DROP CONSTRAINT "FK_ae9f2234d7f72bf22437186fda1"`);
        await queryRunner.query(`ALTER TABLE "tag_accounts_account" DROP CONSTRAINT "FK_4121f1577f3dc85cebd9b109aa7"`);
        await queryRunner.query(`ALTER TABLE "account" DROP CONSTRAINT "FK_60328bf27019ff5498c4b977421"`);
        await queryRunner.query(`ALTER TABLE "post" DROP CONSTRAINT "FK_5c1cf55c308037b5aca1038a131"`);
        await queryRunner.query(`ALTER TABLE "post" DROP CONSTRAINT "FK_6cd0258bc7d0d3bf4707895b13b"`);
        await queryRunner.query(`ALTER TABLE "audit" DROP CONSTRAINT "FK_7ae389e858ad6f2c0c63112e387"`);
        await queryRunner.query(`ALTER TABLE "auditInformation" DROP CONSTRAINT "FK_76f53a1b0bc32bd119d03134bb6"`);
        await queryRunner.query(`ALTER TABLE "cloundinary" DROP CONSTRAINT "FK_d465d84c96697a409b7117ccd98"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ae9f2234d7f72bf22437186fda"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4121f1577f3dc85cebd9b109aa"`);
...
exports.generateDatabase1652843553002 = generateDatabase1652843553002;
//# sourceMappingURL=1652843553002-generateDatabase.js.map